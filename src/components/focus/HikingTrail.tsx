...
export const HikingTrail: React.FC<HikingTrailProps> = ({
  environment = 'office',
  milestone = 0,
  isCelebrating = false,
  progress = 0
  ...
  const skyImages = [
    '/lovable-uploads/3e1d695a-83eb-4783-8669-0703955b486e.png',
    ...
    '/lovable-uploads/d2960f6f-feaf-478a-8519-cdcf8186198b.png'
  ];
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      <div 
        ...
        style={{
          backgroundImage: `url(${skyImages[currentImageIndex]})`,
      ...
      <div className="absolute bottom-4 left-4 text-white text-sm font-medium">
        {milestone > 0 && (
          <div className="flex items-center">
            <span className="mr-2">Progress: Milestone {milestone}/3</span>
          </div>
        )}
      </div>
    </div>
