...
const Dashboard = () => {
  ...
  const getEnvCardClass = () => {
    switch (state.environment) {
      case 'office': 
        return "border-blue-700 bg-gradient-to-br from-blue-900/10 to-blue-500/10 shadow-blue-700/20 shadow-md";
      case 'park': 
        return "border-green-900 bg-gradient-to-br from-green-950/20 to-green-800/10 shadow-green-900/30 shadow-md";
      case 'home': 
        return "border-orange-600 bg-gradient-to-br from-orange-700/10 to-orange-400/10 shadow-orange-600/20 shadow-md";
      case 'coffee-shop': 
        return "border-amber-900 bg-gradient-to-br from-amber-950/30 to-amber-800/10 shadow-amber-900/30 shadow-md";
      case 'library': 
        return "border-gray-700 bg-gradient-to-br from-gray-900/10 to-gray-500/10 shadow-gray-700/20 shadow-md";
      default: 
        return "border-purple-700 bg-gradient-to-br from-purple-900/10 to-purple-500/10 shadow-purple-700/20 shadow-md";
    }
  };
